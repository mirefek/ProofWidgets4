...
import ProofWidgets.Component.InsertButton
...
def Rubiks : Component RubiksProps where
  javascript := include_str ".." / ".." / ".lake" / "build" / "js" / "rubiks2.js"
...
#html <Rubiks cube={puzzle.F.U} />

-- place your cursor after "with_rubiks",
-- solve the Rubik's Cube, then uncomment the last line
